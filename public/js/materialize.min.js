    ...
    V.prototype = {
        ...
        defaults: {
            ...
            if (d && f && c) {
                ...
                var g = !this.pTime || a.timeStamp - this.pTime < b.interval, h = !this.pCenter || I(this.pCenter, a.center) < b.posThreshold;
...
Vel = jQuery ? jQuery.Velocity : $ ? $.Velocity : Velocity, function (a) {
    a.fn.collapsible = function (b, c) {
        ...
        return b = a.extend(d, b), this.each(function () {
            function d(b) {
                l = k.find("> li > .collapsible-header"), b.hasClass("active") ? b.parent().addClass("active") : b.parent().removeClass("active"), b.parent().hasClass("active") ? b.siblings(".collapsible-body").stop(!0, !1).slideDown({
                        duration: 350,
                        easing: "easeOutQuart",
                        queue: !1,
                        complete: function () {
            ...
            var k = a(this), l = a(this).find("> li > .collapsible-header"), m = k.data("collapsible");
            if (c >= 0 && c < l.length) {
                var n = l.eq(c);
        ...
        return "open" === b ? (this.each(function () {
                a(this).trigger("open")
                    ...
                    function e(b) {
                        ...
                        var c = window.innerHeight, e = g.innerHeight(), k = g.offset().left, l = g.offset().top - a(window).scrollTop(), m = h.alignment, n = 0, o = 0, p = 0;
                        h.belowOrigin === !0 && (p = e);
        ...
        init: function (c) {
            ...
            return c = a.extend(e, c), this.each(function () {
                var e = a(this), f = a(this).attr("id") || "#" + a(this).data("target"), g = function () {
                    ...
                    var g = {
                        duration: c.outDuration, queue: !1, ease: "easeOutCubic", complete: function () {
                    ...
                    if (h.css("overflow", "hidden"), h.width(i), !e.hasClass("open")) {
                        ...
                        var l = {
                            duration: c.inDuration, queue: !1, ease: "easeOutCubic", complete: function () {
    ...
    var b = {
        init: function (b) {
            ...
            return b = a.extend(c, b), this.each(function () {
                var c, d, e, f, g, h = a(this), i = a(window).width(), j = h.find("li.tab a"), k = h.width(), l = a(), m = Math.max(k, h[0].scrollWidth) / j.length, n = prev_index = 0, o = !1, p = 300, q = function (a) {
                    return k - a.position().left - a.outerWidth() - h.scrollLeft()
                }, r = function (a) {
                    return a.position().left + h.scrollLeft()
                }, s = function (a) {
                    n - a >= 0 ? (f.velocity({right: q(c)}, {
                            duration: p,
                            queue: !1,
                            easing: "easeOutQuad"
                        }), f.velocity({left: r(c)}, {
                            ...
                            queue: !1,
                            easing: "easeOutQuad"
                        }), f.velocity({right: q(c)}, {duration: p, queue: !1, easing: "easeOutQuad", delay: 90}))
                };
                b.swipeable && i > b.responsiveThreshold && (b.swipeable = !1), c = a(j.filter('[href="' + location.hash + '"]')), 0 === c.length && (c = a(this).find("li.tab a.active").first()), 0 === c.length && (c = a(this).find("li.tab a").first()), c.addClass("active"), n = j.index(c), n < 0 && (n = 0), void 0 !== c[0] && (d = a(c[0].hash), d.addClass("active")), h.find(".indicator").length || h.append('<div class="indicator"></div>'), f = h.find(".indicator"), h.append(f), h.is(":visible") && setTimeout(function () {
                    ...
                    }), e = l.wrapAll('<div class="tabs-content carousel"></div>'), l.css("display", ""), a(".tabs-content.carousel").carousel({
                        fullWidth: !0,
                        noWrap: !0,
                    ...
                    if (!a(this).attr("target")) {
                        ...
                        c.position();
                        c.addClass("active"), prev_index = n, n = j.index(a(this)), n < 0 && (n = 0), b.swipeable ? l.length && l.carousel("set", n) : (void 0 !== d && (d.show(), d.addClass("active"), "function" == typeof b.onShow && b.onShow.call(this, d)), void 0 === f || f.is(d) || (f.hide(), f.removeClass("active"))), g = setTimeout(function () {
                            o = !1
                ...
                f.on({
                    "mouseenter.tooltip": function (a) {
                        ...
                        p = !1, clearTimeout(o), setTimeout(function () {
                            p !== !0 && (k.velocity({opacity: 0, translateY: 0, translateX: 0}, {
                                duration: 225,
                                queue: !1
    ...
    var g = e(a);
    a && f.appendChild(g), g.style.opacity = 0, Vel(g, {translateY: "-35px", opacity: 1}, {
        duration: 300,
        easing: "easeOutCubic",
        queue: !1
    });
            ...
            b = a.extend(c, b), a(this).each(function () {
                ...
                b.draggable && (f.on("click", function () {
                    ...
                    if ("touch" == c.gesture.pointerType) {
                        var d = (c.gesture.direction, c.gesture.center.x), f = (c.gesture.center.y, c.gesture.velocityX, a("body")), h = a("#sidenav-overlay"), j = f.innerWidth();
                    ...
                    if ("touch" == c.gesture.pointerType) {
                        var d = a("#sidenav-overlay"), g = c.gesture.velocityX, j = c.gesture.center.x, k = j - b.menuWidth, l = j - b.menuWidth / 2;
                    ...
                    if (i === !0) i = !1, h = !1, g(); else {
                        var c = a("body"), d = a('<div id="sidenav-overlay"></div>'), j = c.innerWidth();
    ...
    function b(b, c, d, e) {
        ...
        return a.each(f, function (a, f) {
            if (f.height() > 0) {
                var h = f.offset().top, i = f.offset().left, j = i + f.width(), k = h + f.height(), l = !(i > c || j < e || h > d || k < b);
                l && g.push(f)
            }
        }), g
    }
    ...
    function c(c) {
        ++i;
        var d = e.scrollTop(), f = e.scrollLeft(), h = f + e.width(), k = d + e.height(), l = b(d + j.top + c || 200, h + j.right, k + j.bottom, f + j.left);
    ...
    a(document).ready(function () {
        ...
        a(document).on("change", c, function () {
            ...
            var b = void 0 !== a.attr("data-length"), c = parseInt(a.attr("data-length")), d = a.val().length;
        ...
        a(document).on("change", g, function (b) {
            ...
            var d = a(this).attr("max"), e = a(this).width() - 15, f = (a(this).parent(".range-field").outerWidth() - e || 0, a(this).val() * (e / d));
            c.hasClass("active") || c.velocity({
                height: "30px",
                width: "30px",
                top: "-30px",
                marginLeft: "5px"
            }, {duration: 300, easing: "easeOutExpo"}), c.addClass("active").css("left", f)
        }), a(document).on("mousedown touchstart", g, function (b) {
            var c = a(this).siblings(".thumb"), d = a(this).attr("max"), e = a(this).width() - 15, f = (a(this).parent(".range-field").outerWidth() - e || 0, a(this).val() * (e / d));
            c.length <= 0 && (c = a('<span class="thumb"><span class="value"></span></span>'), a(this).after(c)), c.find(".value").html(a(this).val()), h = !0, a(this).addClass("active"), c.hasClass("active") || c.velocity({
                ...
                top: "-30px",
                marginLeft: "5px"
            }, {duration: 300, easing: "easeOutExpo"}), "input" !== b.type && c.addClass("active").css("left", f)
            ...
            var c = a(this).children(".thumb"), d = a(this).find(g), e = d.attr("max"), f = d.width() - 15, i = (a(this).outerWidth() - f || 0, d.val() * (f / e));
            h && (c.hasClass("active") || c.velocity({
                height: "30px",
                width: "30px",
                top: "-30px",
                marginLeft: "5px"
                ...
                duration: 300,
                easing: "easeOutExpo"
            }), c.addClass("active").css("left", i), c.find(".value").html(c.siblings(g).val()))
        ...
        a(this).each(function () {
            ...
            if (!d.hasClass("browser-default")) {
                ...
                var i = a('<ul id="select-options-' + g + '" class="dropdown-content select-dropdown ' + (e ? "multiple-select-dropdown" : "") + '"></ul>'), j = d.children("option, optgroup"), k = [], l = !1, m = d.find("option:selected").html() || d.find("option:first").html() || "", n = function (b, c, d) {
                    var f = c.is(":disabled") ? "disabled " : "", g = "optgroup-option" === d ? "optgroup-option " : "", h = e ? '<input type="checkbox"' + f + "/><label></label>" : "", j = c.data("icon"), k = c.attr("class");
                    if (j) {
                        var l = "";
            ...
            return b = a.extend(c, b), this.each(function () {
                ...
                h.hammer({prevent_default: !1}).bind("pan", function (a) {
                    if ("touch" === a.gesture.pointerType) {
                        clearInterval(g);
                        var b = a.gesture.direction, c = a.gesture.deltaX, d = a.gesture.velocityX, e = a.gesture.velocityY;
    ...
    var b = function (b) {
        ...
        if ("true" !== b.attr("data-open")) {
            ...
            j.append(l), c = i.left - g / 2 + i.width / 2, d = h - i.bottom, f = g / l.width(), b.attr("data-origin-bottom", i.bottom), b.attr("data-origin-left", i.left), b.attr("data-origin-width", i.width), b.addClass("active"), b.attr("data-open", !0), b.css({
                ...
                }), j.css({overflow: "visible", transform: "", transition: "transform .2s"}), setTimeout(function () {
                    b.css({overflow: "hidden", "background-color": m}), l.css({
                        transform: "scale(" + f + ")",
    ...
    Materialize.scrollFire = function (a) {
        var c = function () {
            for (var b = window.pageYOffset + window.innerHeight, c = 0; c < a.length; c++) {
                var d = a[c], e = d.selector, f = d.offset, g = d.callback, h = document.querySelector(e);
                if (null !== h) {
            ...
            return this.each(function (c) {
                ...
                function i(c) {
                    ...
                    if (t = "number" == typeof c ? c : t, u = Math.floor((t + w / 2) / w), f = t - u * w, g = f < 0 ? 1 : -1, i = -g * f * 2 / w, e = x >> 1, b.fullWidth ? k = "translateX(0)" : (k = "translateX(" + (M[0].clientWidth - r) / 2 + "px) ", k += "translateY(" + (M[0].clientHeight - s) / 2 + "px)"), N) {
                        var m = u % x, n = L.find(".indicator-item.active");
                ...
                function o(a) {
                    var b, c, d;
                    if (v)if (b = f(a), y = g(a), c = z - b, d = Math.abs(A - y), d < 30 && !J) (c > 2 || c < -2) && (I = !0, z = b, i(t + c)); else {
                ...
                function p(a) {
                    if (v)return v = !1, clearInterval(H), C = t, (D > 10 || D < -10) && (B = .9 * D, C = t + B), C = Math.round(C / w) * w, b.noWrap && (C >= w * (x - 1) ? C = w * (x - 1) : C < 0 && (C = 0)), B = C - t, G = Date.now(), requestAnimationFrame(k), I && (a.preventDefault(), a.stopPropagation()), !1
                }

                var q, r, s, t, u, v, w, x, z, A, B, C, D, E, F, G, H, I, J, K = d + c, L = a('<ul class="indicators"></ul>'), M = a(this), N = M.attr("data-indicators") || b.indicators;
                if (M.hasClass("initialized"))return a(this).trigger("carouselNext", [1e-6]), !0;
                if (b.fullWidth) {
                    b.dist = 0;
    ...
    var b = {
        init: function (b) {
            return this.each(function () {
                var c = a("#" + a(this).attr("data-activates")), d = (a("body"), a(this)), e = d.parent(".tap-target-wrapper"), f = e.find(".tap-target-wave"), g = e.find(".tap-target-origin"), h = d.find(".tap-target-content");
                ...
                var i = function () {
                    ...
                    var j = c.outerWidth(), k = c.outerHeight(), l = b ? c.offset().top - a(document).scrollTop() : c.offset().top, m = b ? c.offset().left - a(document).scrollLeft() : c.offset().left, n = a(window).width(), o = a(window).height(), p = n / 2, q = o / 2, r = m <= p, s = m > p, t = l <= q, u = l > q, v = m >= .25 * n && m <= .75 * n, w = d.outerWidth(), x = d.outerHeight(), y = l + k / 2 - x / 2, z = m + j / 2 - w / 2, A = b ? "fixed" : "absolute", B = v ? w : w / 2 + j, C = x / 2, D = t ? x / 2 : 0, E = 0, F = r && !v ? w / 2 - j : 0, G = 0, H = j, I = u ? "bottom" : "top", J = j > k ? 2 * j : 2 * j, K = J, L = x / 2 - K / 2, M = w / 2 - J / 2, N = {};
